...
function Deferred_promise() {
  ...
  function promise(cb) {
    return pr.then(
      function () {
        pr.deferred_.resolve.apply(pr.deferred_, arguments);
        if (typeof cb === 'function')
          cb.apply(pr.deferred_, slice.apply(arguments).unshift(null));
      },
      function () {
        pr.deferred_.reject.apply(pr.deferred_, arguments);
        if (typeof cb === 'function')
          cb.apply(null, arguments);
      },
      function () {
        pr.deferred_.notify.apply(pr.deferred_, arguments);
      });
  }
}
